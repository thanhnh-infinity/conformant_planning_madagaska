...
CONFIGURATION= -DLBD -DREPRTHREE -DWEIGHTS #-DMULTICORE #-DSPREAD -DCOSTS -DCFMA  -DCP3
...
#GCCOPTIMIZE= $(ARCH) -O3 -fprefetch-loop-arrays -funroll-loops -momit-leaf-frame-pointer #-falign-functions=64
...
OBJ = $(PARSER).tab.o main.o asyntax.o lex.yy.o tables.o operators.o invariants.o intsets.o cleanup.o translate2sat.o scc.o clausesets.o printplan.o clausedb.o dimacsinput.o ground.o aconformant.o
HDR = main.h asyntax.h tables.h operators.h invariants.h intsets.h cleanup.h scc.h intsets.h translate2sat.h ordintsets.h clausedb.h interface.h printplan.h dimacsinput.h aconformant.h
